...
const Timeline = () => {
  ...
  <div>
    <div className='timeline-all'>
      <div className="day-2024-4-27">
        <div className='timeline-item'>
            <div className='date-container'>
              <span className='date'></span>
              <p className='day'>2024/4/27</p>
            </div>
            <div className='content'>
              <h2>新入生歓迎会2024にて概要を発表しました。</h2>
            </div>
          </div>
          <div className='image-timeline'>
            <img src={process.env.PUBLIC_URL + '/iputapp_overviewTop.png'} width='450'  alt='home-page' className='app-home-page'/>
          </div>  
      </div>
