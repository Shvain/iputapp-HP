...
const Projects = () => {
  ...
  return (
    <div className='project-card'>
      ...
      >
        <img src={process.env.PUBLIC_URL + '/lounas_card.png'} width='240'  alt='lounas_card' className='projects-lounas-card'/>
        <p style={{color: '#0066FF'}}  className='lounas_link'>Available now ➜</p>
      </div>

      <div 
        className='prinlup'>
        <img src={process.env.PUBLIC_URL + '/prinlup-card.png'} width='310'  alt='prinlup' className='projects-prinlup-card'/>
